...
sum(Total_Revenue) as TotalRev, sum(Total_Revenue) / (select sum(Total_Revenue) from stg_Churn) * 100.0 as RevPercentage
from stg_Churn
...
-- how many items we have in a particular column
